...
const getSortedUniqueSkills = (array) => array.reduce((acc, user) => [...acc, ...user.skills], [])
.filter((user, skill, arr) => arr.indexOf(user) === skill)
.sort();

// const getSortedUniqueSkills = (array) => array.reduce((acc, user) => [...acc, ...user.skills], []).
// filter((user, skill, arr) => arr.indexOf(user === skill).sort());
